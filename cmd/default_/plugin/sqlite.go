...
func initSqlite() error {
	...
	if sqlite_path_err != nil {
		return errors.New("db file not found:" + sqlite_path_err.Error() + " please check storage folder path , if still not working please re-download your  program and restart")
	}
