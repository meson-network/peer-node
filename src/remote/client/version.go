...
func GetNodeVersionFromServer() (latestVersion string, allowVersion string, downloadHost string, err error) {
	...
	return result.Latest_version, result.Allow_version, result.Download_host, nil
}
